...
<body id="page-top">
    ...
    <nav class="navbar navbar-light navbar-expand-md navbar navbar-expand-lg fixed-top" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#">Eventify</a><button data-toggle="collapse" class="navbar-toggler navbar-toggler-right" data-target="#navbarResponsive" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"
                value="Menu"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item nav-link js-scroll-trigger" role="presentation"><a class="nav-link active js-scroll-trigger" href="${contextPath}/login">Login</a></li>
                    <li class="nav-item nav-link js-scroll-trigger" role="presentation"><a class="nav-link js-scroll-trigger" href="${contextPath}/registration">Register</a></li>
                    <li class="nav-item nav-link js-scroll-trigger" role="presentation"></li>
                </ul>
            </div>
        </div>
    </nav>
    <header class="masthead" style="background-image:url('${contextPath}/resources/assets/img/intro-bg.jpg');">
        <div class="intro-body" style="background: #49505785;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h1 class="brand-heading">Eventify</h1>
                        <p class="intro-text">One stop for booking all events nearby you gather your friends and book now :)&nbsp;</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p>Eventify is a online event booking platform . You can book any event nearby you or around the world in Eventify. for that &nbsp;<a href="#">Register</a>. The theme is open source, and you can use it for any purpose, personal or commercial.</p>
    ...
    <section id="download" class="download-section content-section text-center" style="background-image:url('${contextPath}/resources/assets/img/login.png');filter:blur(10px); z-index:-1;">
        <div class="container" style="filter:blur(0);z-index:100;">
            <div class="col-lg-8 mx-auto">
